    ...
    return (
        ...
        <div id="project" className="min-h-screen flex flex-col items-center justify-center relative  text-white py-20">
            <div className="text-center px-4 z-10 max-w-6xl">
                ...
                <p className="text-gray-400 w-full text-lg mb-8 max-w-6xl text-left ">
...

                {
                    project.status === "In Progress" && (
                        ...
                        <div className="mt-8 ">
                            ...
                            <StatusCard title="Status" status={project.status} items={project.statusDescription} />
                ...
                <div className="mt-8 ">
                    {
                        ...
                        <p className="text-gray-400 text-lg mb-8 max-w-6xl text-center ">
                            This project deployed on a private server.
                        </p>
                    }
                </div>
